...
def install_brew_dependencies
  ...
  run %{brew install coreutils asdf starship flycut vim ack direnv git watch tree zlib graphviz ffmpeg httpie boost curl wget webp libxml2 libyaml carthage jq terraform protobuf kubectx fzf zoxide}
