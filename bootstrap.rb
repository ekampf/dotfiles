...
def install_brew_dependencies
    ...
    run %{brew install git python scala scipy numpy graphviz swiftlint scala redis memcached apache-spark ffmpeg httpie boost curl wget webp libxml2 libyaml}
end
